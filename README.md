...
const result: strin | boolean = isLogin || "<div>로그인 하세요</div>";
...
const result: strin | boolean = isLogin && "<div>어서오세요</div>";
...
```ts
const userInfo = { age: 22, name: "hong", city: "city" };
let age;
if (userInfo.age) {
  age = userInfo.age;
}
